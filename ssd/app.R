...
aws <- 'ec2-54-173-12-47.compute-1.amazonaws.com' # Prod
aws_port <- ':8080'
...
ui <- dashboardPage(skin = 'green',
                    ...
                    dashboardSidebar(
                      sidebarMenu(
                        ...
                        menuItem("Estructura de ecosistemas", tabName = "tab_ecosystem", startExpanded = TRUE,
                                 menuSubItem("Bosques", tabName = "in_forest"),
                                 menuSubItem("Coberturas de la tierra", tabName = "in_clc"),
                        ...
                        menuItem("Poblaciones de especies", tabName = "tab_species", startExpanded = TRUE,
                                 menuSubItem("UICN", tabName = "in_uicn"),
                                 menuSubItem("Biomodelos", tabName = "in_biod"),
                                 menuSubItem("GBIF", tabName = "in_rec")
                        ),
                        menuItem("Toma de decisiones", tabName = "tab_managment", startExpanded = TRUE,
                      ...
                      tabItems(
                        ...
                        tabItem("draw",
                                ...
                                fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,  
                                  #fluidRow(column(width = 12, box(width = 12, id = "box_draw", collapsible = TRUE, title = 'Instrucciones', p("Box 1")))),
                                  column(width = 4,
                        ...
                        tabItem("in_forest",
                                ...
                                #h5(''),
                                fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                                  fluidRow(column(width = 12, box(width = 12, id = "box_forest", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie en bosque en un área determinada para un", 
                                                                          "periodo de tiempo particular. La definición de bosque depende a su vez de un", 
                                  ...
                                  column(width = 4, sliderInput(inputId = "forestyearrng", label = 'Rango temporal',
                                                                min = 1990, max = 2021, value=c(2000, 2021), sep = ""),
                        ...
                        tabItem("in_clc",
                                ...
                                fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                                  ...
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_clc", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie en las cateogrías de la tierra Corine Land Cover", 
                                                                          "para las fechas 2000-2002, 2005-2009 y 2012-2012 en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='http://www.siac.gov.co/catalogo-de-mapas'>acá</a> (buscar 'Cobertura de la tierra')", 
                                                                             "y a los metadatos <a href='http://geoservicios.ideam.gov.co/geonetwork/srv/spa/catalog.search#/metadata/506e6ae8-19f7-4588-b643-58746046e753'>acá</a> </p>")
                                                                  )
                                  ))), #/box text
                        ...
                        tabItem("in_red",
                                # Box text
                                fluidRow(column(width = 12, box(width = 12, id = "box_red", collapsible = TRUE, title = 'Detalles',
                                                                p(paste("Este indicador mide la superficie en las cateogrías del mapa de Lista roja de ecosistemas", 
                                                                        "en un área particular")
                                                                ), 
                                                                HTML(paste("<p>Acceda a los datos originales <a href='http://reporte.humboldt.org.co/biodiversidad/2017/cap2/204/#seccion1", 
                                                                           "y a los metadatos <a href='http://reporte.humboldt.org.co/biodiversidad/2017/cap2/204/#seccion1'>acá</a> </p>")
                                                                )
                                ))),
                        ...
                        tabItem("in_biot",
                                # Box text
                                fluidRow(column(width = 12, box(width = 12, id = "box_biot", collapsible = TRUE, title = 'Detalles',
                                                                p(paste("Este indicador mide la superficie en las cateogrías de regiones bióticas", 
                                                                        "en un área particular")
                                                                ), 
                                                                HTML(paste("<p>Acceda a los datos originales <a href='http://bart.ideam.gov.co/cneideam/Capasgeo/Mapa_ecosistemas_Continentales_Marinos_Costeros_100K_V2.1_2017.zip'>acá</a> (campo 'region_biotic')", 
                                                                           "y a los metadatos <a href='http://geoservicios.ideam.gov.co/geonetwork/srv/spa/catalog.search#/metadata/0684d637-5b6a-40e8-80f4-bdf915b3e3da'>acá</a> </p>")
                                                                )
                                ))), #/box text
                        ...
                        tabItem("in_biom",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_biom", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie en las cateogrías de biomas", 
                                                                          "en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='http://bart.ideam.gov.co/cneideam/Capasgeo/Mapa_ecosistemas_Continentales_Marinos_Costeros_100K_V2.1_2017.zip'>acá</a> (campo 'biomas')", 
                                                                             "y a los metadatos <a href='http://geoservicios.ideam.gov.co/geonetwork/srv/spa/catalog.search#/metadata/0684d637-5b6a-40e8-80f4-bdf915b3e3da'>acá</a> </p>")
                                                                  )
                                  ))), #/box text
                        ...
                        tabItem("in_dry",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_dry", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie de bosque seco tropical", 
                                                                          "en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='http://sig.anla.gov.co:8083/resources/DESCARGA_SIAC/IAVH/BosqueSecoTropical_100K.zip'>acá</a>", 
                                                                             "y a los metadatos <a href='http://geonetwork.humboldt.org.co/geonetwork/srv/spa/catalog.search#/metadata/6ccd867c-5114-489f-9266-3e5cf657a375'>acá</a> </p>")
                                                                  )
                                  ))), #/box text
                        ...
                        tabItem("in_param",
                              fluidRow(
                                # Box text
                                fluidRow(column(width = 12, box(width = 12, id = "box_param", collapsible = TRUE, title = 'Detalles',
                                                                ...
                                                                HTML(paste("<p>Acceda a los datos originales <a href='http://geonetwork.humboldt.org.co/geonetwork/srv/api/records/c9a5d546-33b5-41d6-a60e-57cfae1cff82/attachments/Complejos_Paramos_100K.7z'>acá</a>", 
                                                                           "y a los metadatos <a href='http://geonetwork.humboldt.org.co/geonetwork/srv/spa/catalog.search#/metadata/c9a5d546-33b5-41d6-a60e-57cfae1cff82'>acá</a> </p>")
                                                                )
                                ))), #/box text
                                  column(width = 6, 
                                         fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                        ...
                        tabItem("in_ap",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_ap", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie de áreas protegidas", 
                                                                          "en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='http://mapas.parquesnacionales.gov.co/services/pnn/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=pnn:runap2&maxFeatures=10000&outputFormat=SHAPE-ZIP'>acá</a>", 
                                                                             "y a los metadatos <a href='http://geonetwork.parquesnacionales.gov.co/geonetwork/srv/spa/metadata.show?id=10048&currTab=simple'>acá</a> </p>")
                                                                  )
                                  ))), #/box text
                                  column(width = 6, 
                                         fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                        ...
                        tabItem("in_cole",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_cole", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie de territorios coelctivos", 
                                                                          "en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='https://urtdatosabiertos-uaegrtd.opendata.arcgis.com/datasets/0615ab25b67d451ea7c0ebb9de63b246_0.zip?outSR=%7B%22latestWkid%22%3A3116%2C%22wkid%22%3A3116%7D'>acá</a> y <a href='https://urtdatosabiertos-uaegrtd.opendata.arcgis.com/datasets/143547bd213d4b92a0ffd981210594e0_0.zip?outSR=%7B%22latestWkid%22%3A3116%2C%22wkid%22%3A3116%7D'>acá</a>", 
                                                                             "y a los metadatos <a href='https://www.datos.gov.co/dataset/Open-Data-Intervencion-Territorios-Ind/mb6v-cfs3'>acá</a> y <a href='https://www.datos.gov.co/dataset/Open-Data-Intervencion-Territorios-Afro/7bxi-h8hy'>acá</a> </p>")
                                                                  )
                                  ))), #/box text
                                  column(width = 6, 
                                         fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                        ...
                        tabItem("in_sma",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_sma", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide la superficie de áreas protegidas", 
                                                                          "en un área particular")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales <a href='https://www.arcgis.com/sharing/rest/content/items/0b7ef68893f04da1bb1770fa2f91768d/data'>acá</a> ", 
                                                                             "</p>")
                                                                  )
                                  ))), #/box text
                        ...
                        tabItem("in_comp",
                                # Box text
                                fluidRow(column(width = 12, box(width = 12, id = "box_comp", collapsible = TRUE, title = 'Detalles',
                                                                p(paste("Este indicador mide la superficie de categorías de factores de compensación de ecosistemas", 
                                                                        "en un área particular")
                                                                ), 
                                                                HTML(paste("<p>Acceda a los datos originales <a href='http://sig.anla.gov.co:8083/resources/DESCARGA_SIAC/MADS/FC_FactoresCompensacion_2018.zip'>acá</a> ", 
                                                                           "</p>")
                                                                )
                                ))), #/box text
                                fluidRow(
                        ...
                        tabItem("in_uicn",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_uicn", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Listado de especies según la Unión Internacional de la Conservación de la Naturaleza - UICN.",
                                                                  "Esta fuente de datos es útil para conocer especies cuyas distribuciones son conocidas por expertos.",
                                                                  "Generalmente son mapas de grupos taxonómicos conocidos soportado por varias fuentes", 
                                                                          "")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales y metadatos <a href='https://www.iucnredlist.org/resources/spatial-data-download'>acá</a>", 
                                                                             "</p>")
                                                                  )
                                  ))), #/box text
                                  column(width = 6, 
                        ...
                        tabItem("in_biod",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_biod", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Listado de especies según la plataforma Biomodelos (Instituto Humboldt).",
                                                                          "Esta fuente de datos es útil para conocer especies cuyas distribuciones son poco conocidas por expertos.",
                                                                          "Generalmente son mapas de grupos taxonómicos pocos conocidos para los que se usan modelos estadísticos y aportes de expertos para generar la distribución geográfica.", 
                                                                          "")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales y metadatos <a href='http://biomodelos.humboldt.org.co/'>acá</a>", "</p>")
                                                                  )
                                  ))), #/box text
                        ...
                        tabItem("in_rec",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_rec", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Listado de especies según la infraestructura global en información de biodiversidad (GBIF).",
                                                                          "Esta fuente de datos es útil para conocer especies cuyas coordenadas han sido reportadas en sitios puntuales por la comunidad científica y ciencia ciudadana.",
                                                                          "")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales y metadatos <a href='https://www.gbif.org/es/'>acá</a>", "</p>")
                                                                  )
                                  ))), #/box text
                                  column(width = 6, 
                                         fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
                        ...
                        tabItem("in_sur",
                                fluidRow(
                                  # Box text
                                  fluidRow(column(width = 12, box(width = 12, id = "box_sur", collapsible = TRUE, title = 'Detalles',
                                                                  p(paste("Este indicador mide el porcentaje de la superficie de un área particular que cuenta con información de registros biológicos.",
                                                                          "El porcentaje de área se puede medir en pixeles aproximados de 1, 2, 5, 10, 20, 50, 100, 200 y 500km de lado.", "")
                                                                  ), 
                                                                  HTML(paste("<p>Acceda a los datos originales y metadatos <a href='http://reporte.humboldt.org.co/biodiversidad/2015/cap1/103/#seccion4'>acá</a>", "</p>")
                                                                  )
                                  ))), #/box text
                                  column(width = 6, 
                                         fluidRow(#width = 6, status = "info", solidHeader = TRUE, title = "Title", height = 500,
